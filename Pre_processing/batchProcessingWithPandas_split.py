...
def main(inputCSV,outputFilepath,params):
  # outPath = '../output/'
  # CaseTablePath = 'CaseTable'
  # RFPath = 'RF'

  # # inputCSV = os.path.join(outPath, CaseTablePath,'CaseTable_shengyi.csv')
  # inputCSV = os.path.join(outPath, CaseTablePath,'CaseTable.csv')
  # # outputFilepath = os.path.join(outPath, RFPath, 'breast_pre_radiomics_allfeatures_shengyi.csv')
  # outputFilepath = os.path.join(outPath, RFPath, 'radiomics_featuretable.csv')

  # params = os.path.join('../Radiomics_Settings', 'exampleMR_1mm_SV.yaml')
  # params = os.path.join('../Radiomics_Settings', 'exampleMR_NoResampling.yaml')
